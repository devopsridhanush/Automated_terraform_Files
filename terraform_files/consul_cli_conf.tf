...
resource "null_resource" "update_instance" {
  ...
  provisioner "local-exec" {
    command = <<EOT
      ...
      scp -i /home/ubuntu/keys/To_Be_Deleted_Singapore.pem /home/ubuntu/consul_client_config_files/consul_agent.json ubuntu@${data.aws_instance.client_terraform.private_ip}:/tmp/agent.json
      scp -i /home/ubuntu/keys/To_Be_Deleted_Singapore.pem /home/ubuntu/consul_client_config_files/consul_acl.json ubuntu@${data.aws_instance.client_terraform.private_ip}:/tmp/acl.json
      scp -i /home/ubuntu/keys/To_Be_Deleted_Singapore.pem /home/ubuntu/consul_client_config_files/consul_connect.json ubuntu@${data.aws_instance.client_terraform.private_ip}:/tmp/connect.json
      scp -i /home/ubuntu/keys/To_Be_Deleted_Singapore.pem /home/ubuntu/consul_client_config_files/consul_tls.json ubuntu@${data.aws_instance.client_terraform.private_ip}:/tmp/tls.json
